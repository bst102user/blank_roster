  ...
  Future<dynamic> submitDriverData()async{
    getPreferenceData().then((userId) async {
      ...
      var mBody = {
        ...
        "licence_pic": pref.get('lic1_pref')==null?'':pref.get('lic1_pref'),
        "insurance_pic": pref.get('ins1_pref')==null?'':pref.get('ins1_pref'),
        ...
        "licence_pic2": pref.get('lic2_pref')==null?'':pref.get('lic2_pref'),
        "insurance_pic2": pref.get('ins2_pref')==null?'':pref.get('ins2_pref'),
